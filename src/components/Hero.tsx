...
const Hero = () => {
  return <section id="home" className="pt-20 pb-16 bg-gradient-corporate relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
          ...
          <div className="space-y-8">
            ...
            {/* CTA Buttons */}
            <div className="slide-up flex flex-col sm:flex-row gap-4" style={{
            animationDelay: "0.6s"
          }}>
          ...
          <div className="relative">
            ...
            animationDelay: "0.4s"
              ...
              <img src={heroImage} alt="Modern technology solutions and digital transformation" className="w-full h-auto rounded-lg shadow-large" />
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-40 right-10 w-32 h-32 bg-primary/15 rounded-full blur-xl animate-float" style={{
        animationDelay: "1s"
      }}></div>
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-primary/15 rounded-full blur-xl animate-float" style={{
        animationDelay: "2s"
      }}></div>
        
        {/* Tech Grid Pattern */}
        <div className="absolute inset-0 opacity-5 bg-[#516b51]">
        ...
        <div className="absolute bottom-1/3 left-16 w-6 h-6 border border-primary/20 rotate-12 animate-pulse" style={{
        animationDelay: "1.5s"
      }}></div>
      </div>
    </section>;
